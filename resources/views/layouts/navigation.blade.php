        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('decision_tree.index')" :active="request()->routeIs('decision_tree.index')">
                        {{ __('Menu de Serviços') }}
                    </x-nav-link>
                    <x-nav-link :href="route('instructions.index')" :active="request()->routeIs('instructions.index')">
                        {{ __('Instruções dos Serviços') }}
                    </x-nav-link>
